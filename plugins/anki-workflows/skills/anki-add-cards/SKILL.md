...
- Match example-sentence difficulty to the target item. For exam-level
  vocabulary such as Eiken Grade 1, write sentences whose register and
  collocations fit that level instead of simplifying the surrounding context.
